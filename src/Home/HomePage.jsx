...
import takdahImg from "../assets/Takdah.jpg";   // ✅ moved here
import Chatbot from "../Chatbot/Chatbot";

// ✅ Single places export
export const places = [
  {
    id: 1,
    title: "Sittong",
    ...
    readMore:
      "Sittong is known as the orange valley of North Bengal. It is a cluster of villages where you can experience rural charm, visit orange orchards, and stay in homestays while enjoying nature."
  },
  {
    id: 2,
    title: "Lepchajagat",
    ...
    readMore:
      "Lepchajagat is a serene hamlet offering breathtaking views of Kanchenjunga, surrounded by thick forests of rhododendron, oak, and pine. It's perfect for bird watching and peaceful retreats."
  },
  {
    id: 3,
    title: "Tinchuley",
    ...
    readMore:
      "Tinchuley is a small mountain village known for its eco-tourism. It offers panoramic views of the Himalayas, lush tea gardens, and beautiful sunrise points."
  },
  {
    id: 4,
    title: "Lamahatta",
    ...
    readMore:
      "Lamahatta is an eco-tourism village surrounded by pine forests and prayer flags. Its eco-park and watchtower provide a peaceful escape amidst nature."
  },
  {
    id: 5,
    title: "Takdah",
    ...
    readMore:
      "Takdah is famous for its old British bungalows, scenic orchid centers, and vast tea estates. A blend of colonial history and natural beauty."
  }
];
